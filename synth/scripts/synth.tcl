...
# Date:     19 Jan 2022
# Modified: 
# Purpose:  Main synthesis flow using Synopsys DC

# TODO: Integrate open source standard cell library to use

# STATUS: (NOT WORKING) Script currently does not work since an open source
#         standard cell library has not been integrated into the repository yet.


# Set files and parameters

# Verilog/SystemVerilog files
set v_files [list divide1_top.sv divide1.sv fsm.sv adder.sv flopenr.sv mux2.sv mux3.sv]

# Set toplevel
set my_toplevel divide1_top.sv

# Set significant digits
set report_default_significant_digits 6

# V/SV Unconnectoed Pins Output
set verilogout_show_unconnected_pins "true"

# Due to parameterized Verilog, analyze/elaborate must be used
# and not read_verilog 

define_design_lib WORK -path ./WORK
analyze -f sverilog -lib WORK $v_files
...
set_driving_cell  -lib_cell DRIVING_CELL_HERE -pin D $all_in_ex_clk
...
set_load [expr [load_of DRIVING_CELL_HERE/D] * 1] [all_outputs]
